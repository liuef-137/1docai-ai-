...
def _auto_migrate(db):
    ...
    migrations = [
        ...
        ("user", "plan", "VARCHAR(20) NOT NULL DEFAULT 'free'"),
        ...
        ("analysis", "prompt_tokens", "INTEGER"),
        ("analysis", "completion_tokens", "INTEGER"),
        ("analysis", "total_tokens", "INTEGER"),
...
def _create_app():
    ...
    with app.app_context():
        ...
        if Notification.query.count() == 0:
            release_version = app.config.get('APP_VERSION', '0.4.14')
